...
local function load_data(fname)
   local data = file.read(fname) -- Read in all the text as a string
   ...
   return x
   -- vocab_map is a table with words as keys, unique integer codes as values
   -- x is a [1xN] tensor of word codes, where N is number of words in data
end
